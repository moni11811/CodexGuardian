...
3. Let Guardian identify this exact task, sanitize its recent state, create a continuation prompt with the on-device Apple model, restart Codex, and resume the task.
